...
import 'package:schedule1/models/catalog.dart';
...
import 'package:schedule1/pages/details.dart';
            ...
            children: [
              ...
              Padding(
                ...
                child: Container(
                  ...
                  child: StreamBuilder(
                    stream:_firestore.collection("users").doc(_auth.currentUser!.uid).collection('appointment').snapshots(),
